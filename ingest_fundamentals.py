...
fundamentals = {}
def get_universe_and_fundamentals():
    ...
    metrics = set([y for x,y in list(full_df)[1:]])
    ...
    universe = set(list(full_df))
    for metric in func_args:
        universe = universe.intersection(set(data.keys()))
    return fundamentals, universe